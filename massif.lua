...
function init()
  ...
  params:add_control("freq1", "freq1", controlspec.new(20, 4000, "lin", 1, 50, "hz"))
  params:set_action("freq1", function(v) engine.freq1(v) dirty = true end)

  params:add_control("freq2", "freq2", controlspec.new(20, 4000, "lin", 1, 110, "hz"))
  params:set_action("freq2", function(v) engine.freq2(v) dirty = true end)
  
  params:add_control("freq3", "freq3", controlspec.new(20, 4000, "lin", 1, 220, "hz"))
  params:set_action("freq3", function(v) engine.freq3(v) dirty = true end)
  
  params:add_control("freq4", "freq4", controlspec.new(20, 4000, "lin", 1, 500, "hz"))
  params:set_action("freq4", function(v) engine.freq4(v) dirty = true end)
  
  params:add_control("freq5", "freq5", controlspec.new(20, 4000, "lin", 1, 1100, "hz"))
  params:set_action("freq5", function(v) engine.freq5(v) dirty = true end)
  
  params:add_control("freq6", "freq6", controlspec.new(20, 4000, "lin", 1, 2200, "hz"))
  params:set_action("freq6", function(v) engine.freq6(v) dirty = true end)
  
  params:add_control("freq7", "freq7", controlspec.new(20, 4000, "lin", 1, 5200, "hz"))
  params:set_action("freq7", function(v) engine.freq7(v) dirty = true end)
  
  params:add_control("freq8", "freq8", controlspec.new(20, 4000, "lin", 1, 11000, "hz"))
